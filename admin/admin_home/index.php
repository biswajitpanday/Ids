        ...
        <aside>
            <div id="sidebar"  class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <h5 class="centered">Interior Design Site</h5>
            ...
            <section class="wrapper">
                <div class="row">
                  ...
                  <form id="uploadimage" action="" method="post" enctype="multipart/form-data">
                      ...
                      <div class="showback">
                          <label class="col-sm-4 col-sm-4 control-label">Product Name </label>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12">
                      ...
                      <div class="showback">
                          <h4>Product Image Here...</h4>
                      </div>

                      <div class="showback">   
                          <div id="image_preview"><img id="previewing" src="assets/img/noimage.png" /></div>
                          <hr id="line">
                          <div id="selectImage">
                  ...
                  <div class="showback col-lg-12 col-md-12 col-sm-12 centered">
    ...
    <script type="text/javascript">
      $(document).ready(function () {
        var unique_id = $.gritter.add({
                  ...
                  text: '<span class="message"><?php $message = @$_GET['msg']; if($message) echo $message; ?></span>',
